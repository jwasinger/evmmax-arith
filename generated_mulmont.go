...
func mulMont128(f *Field, outBytes, xBytes, yBytes []byte) error {
    var t [2]uint64
    var c [3]uint64

    x := (*[2]uint64)(unsafe.Pointer(&xBytes[0]))[:]
    y := (*[2]uint64)(unsafe.Pointer(&yBytes[0]))[:]
    z := (*[2]uint64)(unsafe.Pointer(&outBytes[0]))[:]
...
// NOTE: assumes x < mod and y < mod
func mulMont192(f *Field, outBytes, xBytes, yBytes []byte) error {
    var t [3]uint64
    var c [3]uint64

    x := (*[3]uint64)(unsafe.Pointer(&xBytes[0]))[:]
    y := (*[3]uint64)(unsafe.Pointer(&yBytes[0]))[:]
    z := (*[3]uint64)(unsafe.Pointer(&outBytes[0]))[:]
...
// NOTE: assumes x < mod and y < mod
func mulMont256(f *Field, outBytes, xBytes, yBytes []byte) error {
    var t [4]uint64
    var c [4]uint64

    x := (*[4]uint64)(unsafe.Pointer(&xBytes[0]))[:]
    y := (*[4]uint64)(unsafe.Pointer(&yBytes[0]))[:]
    z := (*[4]uint64)(unsafe.Pointer(&outBytes[0]))[:]
...
// NOTE: assumes x < mod and y < mod
func mulMont320(f *Field, outBytes, xBytes, yBytes []byte) error {
    var t [5]uint64
    var c [5]uint64

    x := (*[5]uint64)(unsafe.Pointer(&xBytes[0]))[:]
    y := (*[5]uint64)(unsafe.Pointer(&yBytes[0]))[:]
    z := (*[5]uint64)(unsafe.Pointer(&outBytes[0]))[:]
...
// NOTE: assumes x < mod and y < mod
func mulMont384(f *Field, outBytes, xBytes, yBytes []byte) error {
    var t [6]uint64
    var c [6]uint64

    x := (*[6]uint64)(unsafe.Pointer(&xBytes[0]))[:]
    y := (*[6]uint64)(unsafe.Pointer(&yBytes[0]))[:]
    z := (*[6]uint64)(unsafe.Pointer(&outBytes[0]))[:]
...
// NOTE: assumes x < mod and y < mod
func mulMont448(f *Field, outBytes, xBytes, yBytes []byte) error {
    var t [7]uint64
    var c [7]uint64

    x := (*[7]uint64)(unsafe.Pointer(&xBytes[0]))[:]
    y := (*[7]uint64)(unsafe.Pointer(&yBytes[0]))[:]
    z := (*[7]uint64)(unsafe.Pointer(&outBytes[0]))[:]
...
// NOTE: assumes x < mod and y < mod
func mulMont512(f *Field, outBytes, xBytes, yBytes []byte) error {
    var t [8]uint64
    var c [8]uint64

    x := (*[8]uint64)(unsafe.Pointer(&xBytes[0]))[:]
    y := (*[8]uint64)(unsafe.Pointer(&yBytes[0]))[:]
    z := (*[8]uint64)(unsafe.Pointer(&outBytes[0]))[:]
...
// NOTE: assumes x < mod and y < mod
func mulMont576(f *Field, outBytes, xBytes, yBytes []byte) error {
    var t [9]uint64
    var c [9]uint64

    x := (*[9]uint64)(unsafe.Pointer(&xBytes[0]))[:]
    y := (*[9]uint64)(unsafe.Pointer(&yBytes[0]))[:]
    z := (*[9]uint64)(unsafe.Pointer(&outBytes[0]))[:]
...
// NOTE: assumes x < mod and y < mod
func mulMont640(f *Field, outBytes, xBytes, yBytes []byte) error {
    var t [10]uint64
    var c [10]uint64

    x := (*[10]uint64)(unsafe.Pointer(&xBytes[0]))[:]
    y := (*[10]uint64)(unsafe.Pointer(&yBytes[0]))[:]
    z := (*[10]uint64)(unsafe.Pointer(&outBytes[0]))[:]
...
// NOTE: assumes x < mod and y < mod
func mulMont704(f *Field, outBytes, xBytes, yBytes []byte) error {
    var t [11]uint64
    var c [11]uint64

    x := (*[11]uint64)(unsafe.Pointer(&xBytes[0]))[:]
    y := (*[11]uint64)(unsafe.Pointer(&yBytes[0]))[:]
    z := (*[11]uint64)(unsafe.Pointer(&outBytes[0]))[:]
...
// NOTE: assumes x < mod and y < mod
func mulMont768(f *Field, outBytes, xBytes, yBytes []byte) error {
    var t [12]uint64
    var c [12]uint64

    x := (*[12]uint64)(unsafe.Pointer(&xBytes[0]))[:]
    y := (*[12]uint64)(unsafe.Pointer(&yBytes[0]))[:]
    z := (*[12]uint64)(unsafe.Pointer(&outBytes[0]))[:]
