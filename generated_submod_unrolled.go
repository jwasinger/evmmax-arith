...
func SubModUnrolled832(f *Field, out_bytes, x_bytes, y_bytes []byte) (error) {
...
func SubModUnrolled896(f *Field, out_bytes, x_bytes, y_bytes []byte) (error) {
...
func SubModUnrolled960(f *Field, out_bytes, x_bytes, y_bytes []byte) (error) {
...
func SubModUnrolled1024(f *Field, out_bytes, x_bytes, y_bytes []byte) (error) {
